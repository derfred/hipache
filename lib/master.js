...
function Master(config) {
    ...
    if(config.server.loggerModule) {
        var loggerModule = require(config.server.loggerModule)
        var logger = new loggerModule(config.server.logger);
    } else {
        var loggerModule = require('./accesslogger');
        var logger = new loggerModule(config.server.accessLog);
    }
